...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Players with remaining turns were not re-added correctly.
    ...
    // Defect(s) Found: Queue order became incorrect when adding a player midway.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns using 0 were not handled correctly.
    ...
    // Defect(s) Found: Infinite turns using negative values were not handled correctly.
    ...
    // Defect(s) Found: Empty queue exception handling was incorrect.
